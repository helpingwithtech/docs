...
description: "Install the Unscrambled Tabs Chrome extension from the Web Store, pin it to your toolbar, choose how it opens, and see what the permissions are for"
icon: "download"
---
...
3. Pin the extension so the toolbar button is always visible: click the puzzle piece in the Chrome toolbar, find **Unscrambled Tabs**, and click the pin icon.
...
Click the **Unscrambled Tabs** button and a card opens over the page you are reading. It floats on top, so nothing on the page moves. If you would rather have a panel docked to the side of the window, that is one setting away. See [Two ways to open it](/help/unscrambled-tabs/dashboard-and-side-panel).
